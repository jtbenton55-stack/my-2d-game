...
| Ninth | Add card-driven modifiers | Phase 6A-6F | Phase 6A implemented 2026-06-15: selected/unlocked/effect card facts now plug into reusable mechanics through `RequirementSet` / `MissionRequirement`. Later Phase 6B-6F work should add modifier data, trigger nodes, route modifiers, starting hooks, and one production card slice. |
