...
var polaroid_data: Dictionary = {
	"taco_bell_polaroid": {"title": "The Drop", "description": "Louis's bag, recovered. The first thread in a larger knot.", "color": Color(0.8, 0.6, 0.3), "memory": "The Taco Bell parking lot smelled like crushed dreams and hot sauce. Bentley found the bag under a Honda Civic. Louis hugged it like a newborn. First clue secured."},
	...
	"taco_bell_smiskis": {"title": "Hidden Smiskis", "description": "Tiny glow pals tucked behind Taco Bell's loading gear.", "color": Color(0.65, 1.0, 0.7), "memory": "Bentley sniffed out a tiny stash of Smiskis near the garage route. Louis called them 'delivery mascots' and refused to explain further."}
}
