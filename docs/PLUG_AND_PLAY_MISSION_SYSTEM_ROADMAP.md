...
| Ninth | Add card-driven modifiers | Phase 6A-6F | Phase 6A implemented 2026-06-15; Phase 6B implemented 2026-06-16 with inspectable `MissionModifierSet` data bundles for card source, requirements, setup effects, and debug notes. Later Phase 6C-6F work should add placed trigger nodes, route modifiers, starting hooks, and one production card slice. |
