...
@export_enum("generated", "scene_authored", "hybrid") var authoring_mode: String = "hybrid"
@export var layout_source_id: String = "scene_markers"
@export var marker_source_id: String = "scene_markers"
