...
func validate() -> Dictionary:
	...
	_require(dock_text.contains("_stamp_selected_from_mouse_event") and dock_text.contains("make_input_local"), "mouse placement does not convert through target container coordinates.", failures)
